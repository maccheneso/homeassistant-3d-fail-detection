...
**The model best.pt trained on print failure datasets**  
(e.g. Roboflow + Ultralytics) **is NOT included** for licensing reasons.  

This repository contains the AI framework + HA integration.  

You must provide your own best.pt model.  
See `HOW_TO_TRAIN_MODEL.md`.

Performance depends on:
- stream quality
- lighting around print area
- Raspberry performance

The system does not replace human supervision; it is an assistant that flags repetitive failures.
